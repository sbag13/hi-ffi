...
pub unsafe extern "C" fn ffi_wrapper_function_with_primitive_args(i: i32, b: bool) {
    let result = function_with_primitive_args(i, b);
    result
}
...
pub unsafe extern "C" fn ffi_wrapper_function_with_string_arg(s: *const i8) {
    let s = unsafe { std::ffi::CStr::from_ptr(s).to_str().unwrap().to_owned() };
    let result = function_with_string_arg(s);
    result
}
...
pub unsafe extern "C" fn ffi_wrapper_function_with_primitive_and_string_arg(
    ...
    let s = unsafe { std::ffi::CStr::from_ptr(s).to_str().unwrap().to_owned() };
    let result = function_with_primitive_and_string_arg(i, b, s);
    result
}
...
pub unsafe extern "C" fn ffi_wrapper_combo_function(
    ...
    let result = combo_function(str1, str2, b, s);
    Box::into_raw(Box::new(result))
}
fn function_taking_struct(s: TestStruct2) {
    match (&s, &TestStruct2 { i32_field: 55 }) {
        (left_val, right_val) => {
            if !(*left_val == *right_val) {
                let kind = ::core::panicking::AssertKind::Eq;
                ::core::panicking::assert_failed(
...
pub unsafe extern "C" fn ffi_wrapper_function_taking_struct(s: *mut TestStruct2) {
    let s = unsafe { (*s).clone() };
    let result = function_taking_struct(s);
    result
}
...
pub fn take_status_before_it_is_defined(status: TestStatus) {
    match (&status, &TestStatus::Pending) {
        (left_val, right_val) => {
            if !(*left_val == *right_val) {
                let kind = ::core::panicking::AssertKind::Eq;
                ::core::panicking::assert_failed(
...
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi___take_status_before_it_is_defined")]
pub unsafe extern "C" fn ffi_wrapper_take_status_before_it_is_defined(status: TestStatus) {
    let result = take_status_before_it_is_defined(status);
    result
}
...
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi___take_struct_and_return_status_before_they_are_defined")]
pub unsafe extern "C" fn ffi_wrapper_take_struct_and_return_status_before_they_are_defined(
    s: *mut TestStruct,
) -> TestStatus {
    let s = unsafe { (*s).clone() };
    let result = take_struct_and_return_status_before_they_are_defined(s);
    result
}
impl TestStruct {
    ...
    pub fn public_method_taking_string(&self, s: String) {
        match (&s, &"Test string from caller") {
            (left_val, right_val) => {
                if !(*left_val == *right_val) {
                    let kind = ::core::panicking::AssertKind::Eq;
                    ::core::panicking::assert_failed(
    ...
    pub fn static_method_taking_struct(s: TestStruct2) {
        match (&s, &TestStruct2 { i32_field: 77 }) {
            (left_val, right_val) => {
                if !(*left_val == *right_val) {
                    let kind = ::core::panicking::AssertKind::Eq;
                    ::core::panicking::assert_failed(
    ...
    pub fn static_method_with_vec_of_structs_result() -> Result<Vec<TestStruct2>, SimpleError> {
        ...
        Ok(<[_]>::into_vec(::alloc::boxed::box_new([s1, s2])))
    }
...
pub unsafe extern "C" fn ffi_wrapper_teststruct_public_method_taking_primitives(
    ...
    let result = (&mut *_self).public_method_taking_primitives(i, b);
    result
}
#[doc(hidden)]
...
pub unsafe extern "C" fn ffi_wrapper_teststruct_public_method_taking_string(
    ...
    let s = unsafe { std::ffi::CStr::from_ptr(s).to_str().unwrap().to_owned() };
    let result = (&mut *_self).public_method_taking_string(s);
    result
}
#[doc(hidden)]
...
pub unsafe extern "C" fn ffi_wrapper_teststruct_public_method_taking_struct(
    ...
    let s = unsafe { (*s).clone() };
    let result = (&mut *_self).public_method_taking_struct(s);
    result
}
#[doc(hidden)]
...
pub unsafe extern "C" fn ffi_wrapper_teststruct_static_method_taking_primitives(i: i32, b: bool) {
    let result = TestStruct::static_method_taking_primitives(i, b);
    result
}
#[doc(hidden)]
#[unsafe(export_name = "hiFfi___TestStruct_static_method_taking_string")]
pub unsafe extern "C" fn ffi_wrapper_teststruct_static_method_taking_string(s: *const i8) {
    let s = unsafe { std::ffi::CStr::from_ptr(s).to_str().unwrap().to_owned() };
    let result = TestStruct::static_method_taking_string(s);
    result
}
#[doc(hidden)]
#[unsafe(export_name = "hiFfi___TestStruct_static_method_taking_struct")]
pub unsafe extern "C" fn ffi_wrapper_teststruct_static_method_taking_struct(s: *mut TestStruct2) {
    let s = unsafe { (*s).clone() };
    let result = TestStruct::static_method_taking_struct(s);
    result
}
#[doc(hidden)]
...
#[doc(hidden)]
#[unsafe(export_name = "hiFfi___TestStruct_method_with_int_result")]
pub unsafe extern "C" fn ffi_wrapper_teststruct_method_with_int_result(
    _self: *mut TestStruct,
    error: bool,
) -> *mut std::result::Result<i64, std::sync::Arc<dyn std::error::Error>> {
    let result = (&mut *_self).method_with_int_result(error);
    Box::into_raw(Box::new(result.map_err(|e| {
        std::sync::Arc::new(e) as std::sync::Arc<dyn std::error::Error>
    })))
}
#[doc(hidden)]
#[unsafe(export_name = "hiFfi___TestStruct_static_method_with_bool_result")]
pub unsafe extern "C" fn ffi_wrapper_teststruct_static_method_with_bool_result(
    error: bool,
) -> *mut std::result::Result<bool, std::sync::Arc<dyn std::error::Error>> {
    let result = TestStruct::static_method_with_bool_result(error);
    Box::into_raw(Box::new(result.map_err(|e| {
        std::sync::Arc::new(e) as std::sync::Arc<dyn std::error::Error>
    })))
}
#[doc(hidden)]
#[unsafe(export_name = "hiFfi___TestStruct_method_with_string_result")]
pub unsafe extern "C" fn ffi_wrapper_teststruct_method_with_string_result(
    _self: *mut TestStruct,
) -> *mut std::result::Result<String, std::sync::Arc<dyn std::error::Error>> {
    let result = (&mut *_self).method_with_string_result();
    Box::into_raw(Box::new(result.map_err(|e| {
        std::sync::Arc::new(e) as std::sync::Arc<dyn std::error::Error>
    })))
}
#[doc(hidden)]
#[unsafe(export_name = "hiFfi___TestStruct_static_method_with_struct_result")]
pub unsafe extern "C" fn ffi_wrapper_teststruct_static_method_with_struct_result(
) -> *mut std::result::Result<TestStruct, std::sync::Arc<dyn std::error::Error>> {
    let result = TestStruct::static_method_with_struct_result();
    Box::into_raw(Box::new(result.map_err(|e| {
        std::sync::Arc::new(e) as std::sync::Arc<dyn std::error::Error>
    })))
}
#[doc(hidden)]
#[unsafe(export_name = "hiFfi___TestStruct_method_with_enum_result")]
pub unsafe extern "C" fn ffi_wrapper_teststruct_method_with_enum_result(
    _self: *mut TestStruct,
) -> *mut std::result::Result<TestStatus, std::sync::Arc<dyn std::error::Error>> {
    let result = (&mut *_self).method_with_enum_result();
    Box::into_raw(Box::new(result.map_err(|e| {
        std::sync::Arc::new(e) as std::sync::Arc<dyn std::error::Error>
    })))
}
#[doc(hidden)]
#[unsafe(export_name = "hiFfi___TestStruct_method_with_vec_of_ints_result")]
pub unsafe extern "C" fn ffi_wrapper_teststruct_method_with_vec_of_ints_result(
    _self: *mut TestStruct,
) -> *mut std::result::Result<Vec<i8>, std::sync::Arc<dyn std::error::Error>> {
    let result = (&mut *_self).method_with_vec_of_ints_result();
    Box::into_raw(Box::new(result.map_err(|e| {
        std::sync::Arc::new(e) as std::sync::Arc<dyn std::error::Error>
    })))
}
#[doc(hidden)]
#[unsafe(export_name = "hiFfi___TestStruct_static_method_with_vec_of_bools_result")]
pub unsafe extern "C" fn ffi_wrapper_teststruct_static_method_with_vec_of_bools_result(
) -> *mut std::result::Result<Vec<bool>, std::sync::Arc<dyn std::error::Error>> {
    let result = TestStruct::static_method_with_vec_of_bools_result();
    Box::into_raw(Box::new(result.map_err(|e| {
        std::sync::Arc::new(e) as std::sync::Arc<dyn std::error::Error>
    })))
}
#[doc(hidden)]
#[unsafe(export_name = "hiFfi___TestStruct_method_with_vec_of_strings_result")]
pub unsafe extern "C" fn ffi_wrapper_teststruct_method_with_vec_of_strings_result(
    _self: *mut TestStruct,
) -> *mut std::result::Result<Vec<String>, std::sync::Arc<dyn std::error::Error>> {
    let result = (&mut *_self).method_with_vec_of_strings_result();
    Box::into_raw(Box::new(result.map_err(|e| {
        std::sync::Arc::new(e) as std::sync::Arc<dyn std::error::Error>
    })))
}
#[doc(hidden)]
#[unsafe(export_name = "hiFfi___TestStruct_static_method_with_vec_of_structs_result")]
pub unsafe extern "C" fn ffi_wrapper_teststruct_static_method_with_vec_of_structs_result(
) -> *mut std::result::Result<Vec<TestStruct2>, std::sync::Arc<dyn std::error::Error>> {
    let result = TestStruct::static_method_with_vec_of_structs_result();
    Box::into_raw(Box::new(result.map_err(|e| {
        std::sync::Arc::new(e) as std::sync::Arc<dyn std::error::Error>
    })))
}
#[doc(hidden)]
#[unsafe(export_name = "hiFfi___TestStruct_method_with_vec_of_bools_result")]
pub unsafe extern "C" fn ffi_wrapper_teststruct_method_with_vec_of_bools_result(
    _self: *mut TestStruct,
) -> *mut std::result::Result<Vec<bool>, std::sync::Arc<dyn std::error::Error>> {
    let result = (&mut *_self).method_with_vec_of_bools_result();
    Box::into_raw(Box::new(result.map_err(|e| {
        std::sync::Arc::new(e) as std::sync::Arc<dyn std::error::Error>
    })))
}
#[doc(hidden)]
#[unsafe(export_name = "hiFfi___TestStruct_static_method_with_vec_of_enum_result")]
pub unsafe extern "C" fn ffi_wrapper_teststruct_static_method_with_vec_of_enum_result(
) -> *mut std::result::Result<Vec<TestStatus>, std::sync::Arc<dyn std::error::Error>> {
    let result = TestStruct::static_method_with_vec_of_enum_result();
    Box::into_raw(Box::new(result.map_err(|e| {
        std::sync::Arc::new(e) as std::sync::Arc<dyn std::error::Error>
    })))
}
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi____drop_vec_of_i8_result")]
pub unsafe extern "C" fn drop_i8_vec_result(
    _self: *mut std::result::Result<Vec<i8>, std::sync::Arc<dyn std::error::Error>>,
) {
    unsafe {
        if !_self.is_null() {
            let _ = Box::from_raw(_self);
...
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi____unwrap_vec_of_i8_result")]
pub unsafe extern "C" fn unwrap_vec_of_i8_result(
    _self: *mut std::result::Result<Vec<i8>, std::sync::Arc<dyn std::error::Error>>,
) -> *mut Vec<i8> {
    unsafe {
        match &*_self {
...
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi____unwrap_err_vec_of_i8_result")]
pub unsafe extern "C" fn unwrap_err_vec_of_i8_result(
    _self: *mut std::result::Result<Vec<i8>, std::sync::Arc<dyn std::error::Error>>,
) -> *mut std::sync::Arc<dyn std::error::Error> {
    unsafe {
        match &*_self {
...
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi____is_err_vec_of_i8_result")]
pub unsafe extern "C" fn is_err_vec_of_i8_result(
    _self: *mut std::result::Result<Vec<i8>, std::sync::Arc<dyn std::error::Error>>,
) -> bool {
    unsafe {
        match &*_self {
...
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi____drop_vec_of_TestStruct2_result")]
pub unsafe extern "C" fn drop_TestStruct2_vec_result(
    _self: *mut std::result::Result<Vec<TestStruct2>, std::sync::Arc<dyn std::error::Error>>,
) {
    unsafe {
        if !_self.is_null() {
            let _ = Box::from_raw(_self);
...
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi____unwrap_vec_of_TestStruct2_result")]
pub unsafe extern "C" fn unwrap_vec_of_TestStruct2_result(
    _self: *mut std::result::Result<Vec<TestStruct2>, std::sync::Arc<dyn std::error::Error>>,
) -> *mut Vec<TestStruct2> {
    unsafe {
        match &*_self {
...
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi____unwrap_err_vec_of_TestStruct2_result")]
pub unsafe extern "C" fn unwrap_err_vec_of_TestStruct2_result(
    _self: *mut std::result::Result<Vec<TestStruct2>, std::sync::Arc<dyn std::error::Error>>,
) -> *mut std::sync::Arc<dyn std::error::Error> {
    unsafe {
        match &*_self {
...
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi____is_err_vec_of_TestStruct2_result")]
pub unsafe extern "C" fn is_err_vec_of_TestStruct2_result(
    _self: *mut std::result::Result<Vec<TestStruct2>, std::sync::Arc<dyn std::error::Error>>,
) -> bool {
    unsafe {
        match &*_self {
...
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi____drop_vec_of_String_result")]
pub unsafe extern "C" fn drop_String_vec_result(
    _self: *mut std::result::Result<Vec<String>, std::sync::Arc<dyn std::error::Error>>,
) {
    unsafe {
        if !_self.is_null() {
            let _ = Box::from_raw(_self);
...
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi____unwrap_vec_of_String_result")]
pub unsafe extern "C" fn unwrap_vec_of_String_result(
    _self: *mut std::result::Result<Vec<String>, std::sync::Arc<dyn std::error::Error>>,
) -> *mut Vec<String> {
    unsafe {
        match &*_self {
...
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi____unwrap_err_vec_of_String_result")]
pub unsafe extern "C" fn unwrap_err_vec_of_String_result(
    _self: *mut std::result::Result<Vec<String>, std::sync::Arc<dyn std::error::Error>>,
) -> *mut std::sync::Arc<dyn std::error::Error> {
    unsafe {
        match &*_self {
...
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi____is_err_vec_of_String_result")]
pub unsafe extern "C" fn is_err_vec_of_String_result(
    _self: *mut std::result::Result<Vec<String>, std::sync::Arc<dyn std::error::Error>>,
) -> bool {
    unsafe {
        match &*_self {
...
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi____drop_i64_result")]
pub unsafe extern "C" fn drop_i64_result(
    _self: *mut std::result::Result<i64, std::sync::Arc<dyn std::error::Error>>,
) {
    unsafe {
        if !_self.is_null() {
            let _ = Box::from_raw(_self);
...
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi____unwrap_i64_result")]
pub unsafe extern "C" fn unwrap_i64_result(
    _self: *mut std::result::Result<i64, std::sync::Arc<dyn std::error::Error>>,
) -> i64 {
    unsafe {
        match &*_self {
...
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi____unwrap_err_i64_result")]
pub unsafe extern "C" fn unwrap_err_i64_result(
    _self: *mut std::result::Result<i64, std::sync::Arc<dyn std::error::Error>>,
) -> *mut std::sync::Arc<dyn std::error::Error> {
    unsafe {
        match &*_self {
...
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi____is_err_i64_result")]
pub unsafe extern "C" fn is_err_i64_result(
    _self: *mut std::result::Result<i64, std::sync::Arc<dyn std::error::Error>>,
) -> bool {
    unsafe {
        match &*_self {
...
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi____drop_vec_of_TestStatus_result")]
pub unsafe extern "C" fn drop_TestStatus_vec_result(
    _self: *mut std::result::Result<Vec<TestStatus>, std::sync::Arc<dyn std::error::Error>>,
) {
    unsafe {
        if !_self.is_null() {
            let _ = Box::from_raw(_self);
...
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi____unwrap_vec_of_TestStatus_result")]
pub unsafe extern "C" fn unwrap_vec_of_TestStatus_result(
    _self: *mut std::result::Result<Vec<TestStatus>, std::sync::Arc<dyn std::error::Error>>,
) -> *mut Vec<TestStatus> {
    unsafe {
        match &*_self {
...
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi____unwrap_err_vec_of_TestStatus_result")]
pub unsafe extern "C" fn unwrap_err_vec_of_TestStatus_result(
    _self: *mut std::result::Result<Vec<TestStatus>, std::sync::Arc<dyn std::error::Error>>,
) -> *mut std::sync::Arc<dyn std::error::Error> {
    unsafe {
        match &*_self {
...
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi____is_err_vec_of_TestStatus_result")]
pub unsafe extern "C" fn is_err_vec_of_TestStatus_result(
    _self: *mut std::result::Result<Vec<TestStatus>, std::sync::Arc<dyn std::error::Error>>,
) -> bool {
    unsafe {
        match &*_self {
...
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi____drop_TestStruct_result")]
pub unsafe extern "C" fn drop_TestStruct_result(
    _self: *mut std::result::Result<TestStruct, std::sync::Arc<dyn std::error::Error>>,
) {
    unsafe {
        if !_self.is_null() {
            let _ = Box::from_raw(_self);
...
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi____unwrap_TestStruct_result")]
pub unsafe extern "C" fn unwrap_TestStruct_result(
    _self: *mut std::result::Result<TestStruct, std::sync::Arc<dyn std::error::Error>>,
) -> *mut TestStruct {
    unsafe {
        match &*_self {
...
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi____unwrap_err_TestStruct_result")]
pub unsafe extern "C" fn unwrap_err_TestStruct_result(
    _self: *mut std::result::Result<TestStruct, std::sync::Arc<dyn std::error::Error>>,
) -> *mut std::sync::Arc<dyn std::error::Error> {
    unsafe {
        match &*_self {
...
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi____is_err_TestStruct_result")]
pub unsafe extern "C" fn is_err_TestStruct_result(
    _self: *mut std::result::Result<TestStruct, std::sync::Arc<dyn std::error::Error>>,
) -> bool {
    unsafe {
        match &*_self {
...
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi____drop_vec_of_bool_result")]
pub unsafe extern "C" fn drop_bool_vec_result(
    _self: *mut std::result::Result<Vec<bool>, std::sync::Arc<dyn std::error::Error>>,
) {
    unsafe {
        if !_self.is_null() {
            let _ = Box::from_raw(_self);
...
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi____unwrap_vec_of_bool_result")]
pub unsafe extern "C" fn unwrap_vec_of_bool_result(
    _self: *mut std::result::Result<Vec<bool>, std::sync::Arc<dyn std::error::Error>>,
) -> *mut Vec<bool> {
    unsafe {
        match &*_self {
...
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi____unwrap_err_vec_of_bool_result")]
pub unsafe extern "C" fn unwrap_err_vec_of_bool_result(
    _self: *mut std::result::Result<Vec<bool>, std::sync::Arc<dyn std::error::Error>>,
) -> *mut std::sync::Arc<dyn std::error::Error> {
    unsafe {
        match &*_self {
...
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi____is_err_vec_of_bool_result")]
pub unsafe extern "C" fn is_err_vec_of_bool_result(
    _self: *mut std::result::Result<Vec<bool>, std::sync::Arc<dyn std::error::Error>>,
) -> bool {
    unsafe {
        match &*_self {
...
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi____drop_u16_vec")]
pub unsafe extern "C" fn drop_u16_vec(_self: *mut Vec<u16>) {
    unsafe {
        if !_self.is_null() {
            let _ = Box::from_raw(_self);
        }
...
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi____with_capacity_u16_vec")]
pub unsafe extern "C" fn with_capacity_u16_vec(capacity: usize) -> *mut Vec<u16> {
    unsafe {
        let vec = Box::new(Vec::with_capacity(capacity));
        Box::into_raw(vec)
    }
...
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi____push_u16_vec")]
pub unsafe extern "C" fn push_u16_vec(_self: *mut Vec<u16>, value: u16) {
    (&mut *_self).push(value);
}
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi____len_u16_vec")]
pub unsafe extern "C" fn len_u16_vec(_self: *mut Vec<u16>) -> usize {
    (&*_self).len()
}
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi____get_u16_vec")]
pub unsafe extern "C" fn get_u16_vec(_self: *mut Vec<u16>, index: usize) -> u16 {
    (&*_self)[index]
}
#[doc(hidden)]
#[unsafe(no_mangle)]
...
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi____drop_i8_vec")]
pub unsafe extern "C" fn drop_i8_vec(_self: *mut Vec<i8>) {
    unsafe {
        if !_self.is_null() {
            let _ = Box::from_raw(_self);
        }
...
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi____with_capacity_i8_vec")]
pub unsafe extern "C" fn with_capacity_i8_vec(capacity: usize) -> *mut Vec<i8> {
    unsafe {
        let vec = Box::new(Vec::with_capacity(capacity));
        Box::into_raw(vec)
    }
...
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi____push_i8_vec")]
pub unsafe extern "C" fn push_i8_vec(_self: *mut Vec<i8>, value: i8) {
    (&mut *_self).push(value);
}
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi____len_i8_vec")]
pub unsafe extern "C" fn len_i8_vec(_self: *mut Vec<i8>) -> usize {
    (&*_self).len()
}
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi____get_i8_vec")]
pub unsafe extern "C" fn get_i8_vec(_self: *mut Vec<i8>, index: usize) -> i8 {
    (&*_self)[index]
}
#[automatically_derived]
...
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi___function_with_unit_expression_result")]
pub unsafe extern "C" fn ffi_wrapper_function_with_unit_expression_result(
) -> *mut std::result::Result<(), std::sync::Arc<dyn std::error::Error>> {
    let result = function_with_unit_expression_result();
    Box::into_raw(Box::new(result.map_err(|e| {
        std::sync::Arc::new(e) as std::sync::Arc<dyn std::error::Error>
    })))
}
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi____drop_unit_result")]
pub unsafe extern "C" fn drop_unit_result(
    _self: *mut std::result::Result<(), std::sync::Arc<dyn std::error::Error>>,
) {
    unsafe {
        if !_self.is_null() {
            let _ = Box::from_raw(_self);
...
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi____unwrap_unit_result")]
pub unsafe extern "C" fn unwrap_unit_result(
    _self: *mut std::result::Result<(), std::sync::Arc<dyn std::error::Error>>,
) -> () {
    unsafe {
        match &*_self {
...
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi____unwrap_err_unit_result")]
pub unsafe extern "C" fn unwrap_err_unit_result(
    _self: *mut std::result::Result<(), std::sync::Arc<dyn std::error::Error>>,
) -> *mut std::sync::Arc<dyn std::error::Error> {
    unsafe {
        match &*_self {
...
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi____is_err_unit_result")]
pub unsafe extern "C" fn is_err_unit_result(
    _self: *mut std::result::Result<(), std::sync::Arc<dyn std::error::Error>>,
) -> bool {
    unsafe {
        match &*_self {
...
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi____drop_vec_of_i32_result")]
...
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi___function_with_vec_bool_result")]
pub unsafe extern "C" fn ffi_wrapper_function_with_vec_bool_result(
    error: bool,
) -> *mut std::result::Result<Vec<bool>, std::sync::Arc<dyn std::error::Error>> {
    let result = function_with_vec_bool_result(error);
    Box::into_raw(Box::new(result.map_err(|e| {
        std::sync::Arc::new(e) as std::sync::Arc<dyn std::error::Error>
    })))
}
...
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi___function_with_vec_string_result")]
pub unsafe extern "C" fn ffi_wrapper_function_with_vec_string_result(
    error: bool,
) -> *mut std::result::Result<Vec<String>, std::sync::Arc<dyn std::error::Error>> {
    let result = function_with_vec_string_result(error);
    Box::into_raw(Box::new(result.map_err(|e| {
        std::sync::Arc::new(e) as std::sync::Arc<dyn std::error::Error>
    })))
}
...
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi___function_with_vec_struct_result")]
pub unsafe extern "C" fn ffi_wrapper_function_with_vec_struct_result(
    error: bool,
) -> *mut std::result::Result<Vec<TestStruct2>, std::sync::Arc<dyn std::error::Error>> {
    let result = function_with_vec_struct_result(error);
    Box::into_raw(Box::new(result.map_err(|e| {
        std::sync::Arc::new(e) as std::sync::Arc<dyn std::error::Error>
    })))
}
...
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi___function_with_vec_enum_result")]
pub unsafe extern "C" fn ffi_wrapper_function_with_vec_enum_result(
    error: bool,
) -> *mut std::result::Result<Vec<TestStatus>, std::sync::Arc<dyn std::error::Error>> {
    let result = function_with_vec_enum_result(error);
    Box::into_raw(Box::new(result.map_err(|e| {
        std::sync::Arc::new(e) as std::sync::Arc<dyn std::error::Error>
    })))
}
pub fn function_taking_some_int(i: Option<i32>, assert_some: bool) {
    if assert_some {
        ...
        if !i.is_none() {
            ::core::panicking::panic("assertion failed: i.is_none()")
        };
    }
}
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi___function_taking_some_int")]
pub unsafe extern "C" fn ffi_wrapper_function_taking_some_int(
    i: *mut Option<i32>,
    assert_some: bool,
) {
    let mut new_opt = None;
    std::mem::swap(&mut new_opt, unsafe { &mut (*i) });
    let result = function_taking_some_int(new_opt, assert_some);
    result
}
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi____some_i32_option")]
pub unsafe extern "C" fn some_i32_option(value: i32) -> *mut std::option::Option<i32> {
    Box::into_raw(Box::new(Some(value)))
}
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi____none_i32_option")]
pub unsafe extern "C" fn none_i32_option() -> *mut std::option::Option<i32> {
    Box::into_raw(Box::new(None))
}
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi____drop_i32_option")]
pub unsafe extern "C" fn drop_i32_option(_self: *mut std::option::Option<i32>) {
    unsafe {
        if !_self.is_null() {
            let _ = Box::from_raw(_self);
        }
...
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi____unwrap_i32_option")]
pub unsafe extern "C" fn unwrap_i32_option(_self: *mut std::option::Option<i32>) -> i32 {
    unsafe {
        match &*_self {
            Some(value) => value.clone(),
            None => {
                ::core::panicking::panic_fmt(format_args!("Called unwrap on an None value"));
            }
        }
    }
}
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi____is_some_i32_option")]
pub unsafe extern "C" fn is_some_i32_option(_self: *mut std::option::Option<i32>) -> bool {
    unsafe { (*_self).is_some() }
}
pub fn function_taking_some_bool(b: Option<bool>, assert_some: bool) {
    if assert_some {
        ...
        if !b.is_none() {
            ::core::panicking::panic("assertion failed: b.is_none()")
        };
    }
}
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi___function_taking_some_bool")]
pub unsafe extern "C" fn ffi_wrapper_function_taking_some_bool(
    b: *mut Option<bool>,
    assert_some: bool,
) {
    let mut new_opt = None;
    std::mem::swap(&mut new_opt, unsafe { &mut (*b) });
    let result = function_taking_some_bool(new_opt, assert_some);
    result
}
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi____some_bool_option")]
pub unsafe extern "C" fn some_bool_option(value: bool) -> *mut std::option::Option<bool> {
    Box::into_raw(Box::new(Some(value)))
}
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi____none_bool_option")]
pub unsafe extern "C" fn none_bool_option() -> *mut std::option::Option<bool> {
    Box::into_raw(Box::new(None))
}
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi____drop_bool_option")]
pub unsafe extern "C" fn drop_bool_option(_self: *mut std::option::Option<bool>) {
    unsafe {
        if !_self.is_null() {
            let _ = Box::from_raw(_self);
        }
...
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi____unwrap_bool_option")]
pub unsafe extern "C" fn unwrap_bool_option(_self: *mut std::option::Option<bool>) -> bool {
    unsafe {
        match &*_self {
            Some(value) => value.clone(),
            None => {
...
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi____is_some_bool_option")]
pub unsafe extern "C" fn is_some_bool_option(_self: *mut std::option::Option<bool>) -> bool {
    unsafe { (*_self).is_some() }
}
pub fn function_taking_some_string(s: Option<String>, assert_some: bool) {
    if assert_some {
        match (&Some("Some string".to_string()), &s) {
            (left_val, right_val) => {
                if !(*left_val == *right_val) {
                    let kind = ::core::panicking::AssertKind::Eq;
                    ::core::panicking::assert_failed(
        ...
        if !s.is_none() {
            ::core::panicking::panic("assertion failed: s.is_none()")
        };
    }
}
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi___function_taking_some_string")]
pub unsafe extern "C" fn ffi_wrapper_function_taking_some_string(
    s: *mut Option<String>,
    assert_some: bool,
) {
    let mut new_opt = None;
    std::mem::swap(&mut new_opt, unsafe { &mut (*s) });
    let result = function_taking_some_string(new_opt, assert_some);
    result
}
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi____some_String_option")]
pub unsafe extern "C" fn some_String_option(
    ptr: *const i8,
    _len: usize,
) -> *mut std::option::Option<String> {
    let value = std::ffi::CStr::from_ptr(ptr).to_str().unwrap().to_owned();
    Box::into_raw(Box::new(Some(value)))
}
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi____none_String_option")]
pub unsafe extern "C" fn none_String_option() -> *mut std::option::Option<String> {
    Box::into_raw(Box::new(None))
}
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi____drop_String_option")]
pub unsafe extern "C" fn drop_String_option(_self: *mut std::option::Option<String>) {
    unsafe {
        if !_self.is_null() {
            let _ = Box::from_raw(_self);
        }
...
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi____unwrap_String_option")]
pub unsafe extern "C" fn unwrap_String_option(
    _self: *mut std::option::Option<String>,
) -> *mut String {
    unsafe {
        match &*_self {
...
#[doc(hidden)]
#[unsafe(no_mangle)]
#[unsafe(export_name = "hiFfi____is_some_String_option")]
pub unsafe extern "C" fn is_some_String_option(_self: *mut std::option::Option<String>) -> bool {
    unsafe { (*_self).is_some() }
}
